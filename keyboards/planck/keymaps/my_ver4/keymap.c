...
INSTRUCTIONS:
    ...
    cmake planck/rev5:KEYMAP:dfu

    ** KEYMAP is the custom keymap i.e. my_current
================================================================= */
...
[_SYMBOLS] = LAYOUT_planck_grid(
    ...
    CAPS, NONE, NONE, NONE, DQUO, AT__, PIPE, LPRN, RPRN, ASTR, SLSH, ENTR,
...
[_NUMERIC] = LAYOUT_planck_grid(
    ...
    SHFT, NONE, NONE, NONE, NONE, NONE, NONE, NONE, NONE, DOT_, SLSH, SHFT,
